export const IMPORT_EXPORT_ENTITIES = {
  ...
  locations: {
    key: "locations",
    title: "Mapa magazynu",
    description: "Mapowanie kodow lokalizacji, stref, alei, poziomow, typow lokalizacji i statusow operacyjnych.",
    supportsImport: true,
    supportsExport: true,
    importFields: [
      ...
      { key: "aisle", label: "Aleja", required: true, aliases: ["aisle", "aleja", "korytarz"] },
      { key: "level", label: "Poziom", required: true, aliases: ["level", "poziom", "poziom_lokacji"] },
      { key: "location_type", label: "Typ lokalizacji", required: true, aliases: ["location_type", "typ_lokalizacji", "type", "typ"] },
      { key: "status", label: "Status", required: false, aliases: ["status"] },
    ],
    exportFields: [
      { key: "code", label: "Lokalizacja" },
      { key: "zone", label: "Strefa" },
      { key: "aisle", label: "Aleja" },
      { key: "level", label: "Poziom" },
      { key: "location_type", label: "Typ lokalizacji" },
      { key: "status", label: "Status" },
    ],
  },
  corrections: {
